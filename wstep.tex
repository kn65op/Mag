...
Do rozpoznawania plam wykorzystano operator Laplace'a, który w~postaci dyskretnej został przedstawiony na rys \ref{fig:laplacian_kernel}. Wszystkie obrazy składające się na reprezentację skali są przetwarzanie za pomocę tego operatora. Następnie wśród otrzymanej struktury trójwymiarowej szukane są lokalne maksima. Skala, w~której wykryto maksmimum określa wielkość danej plamy. Plamy są aproksymowane okręgami o~promieniu wyznaczonym za pomocą wzoru \ref{eq:blobRadius}.
