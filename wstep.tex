...
W dalszej części pracy będzie używane pojęcia rozmiaru skali oraz kroku. Rozmiarem skali jest promień filtru Gaussa. Krok jest to różnica pomiędzy promieniami filtrów Gaussa dwóch kolejnych skal. Wartość kroku jest używana podczas tworzenia reprezentacji skali.
