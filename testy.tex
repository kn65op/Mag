...
Poniżej przedstawiono wyniki porównań pomiędzy obrazami otrzymanymi za pomocą różnych implementacji. Przedstawione są tutaj jedynie dwa obrazy wejściowe wybrane spośród pięciu, dla każdego punktu. Obrazy różnicowe są otoczone ramką w~celu zwiększenia czytelności.
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth]{TestyPoprawnosci/in_pure_03.png}
\end{center}
