...
\begin{figure}
\begin{center}
\includegraphics[width=3cm]{TestyPoprawnosci/in_pure_02.png}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[width=3cm]{TestyPoprawnosci/in_pure_03.png}
\end{center}
...
Na podstawie obrazów różnicowych można stwierdzić, że główne rozbierzności pomiędzy implementacjami występują głównie na krawędziach. Ponadto różnice są niewielkie. Największa różnica nie przekracza $ 0,3% $.
