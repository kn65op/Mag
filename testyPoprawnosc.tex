...
e_{AB} = \frac{\sum_{i}^{P}|sgn(A_{ij}-B_{ij})	|}{P}
\end{equation}
gdzie:

$ e_{AB} $ - współczynnik liczby różnych pikseli,

$ A, B $ - obrazy, dla których wyznaczany jest współczynnik,
...
v_{AB} = \frac{\sum_{i}^{P}|A_{ij}-B_{ij}|}{\sum_{i}^{P}|sgn(A_{ij}-B_{ij})|}
\end{equation}
gdzie:

$ v_{AB} $ - współczynnik wielkości średniego odchylenia wartości piksela,
